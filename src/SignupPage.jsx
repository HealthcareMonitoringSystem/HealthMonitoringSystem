...
export default function SignupPage() {
  ...
  return (
    <div className="flex flex-col w-full h-screen font-serif bg-white text-gray-800">
      ...
      {/* Main Content */}
      <div className="flex flex-1 justify-center items-center gap-[50px] p-10 bg-gradient-to-br from-[#B9DEFB90] to-[#B9DEFB90]">
        {/* Left Section */}
        ...
        {/* Right Section */}
        <div className="flex-1 flex justify-center items-center">
          <div className="bg-[#00796B50] p-10 rounded-lg w-4/5 max-w-[400px] shadow-lg">
            ...
            <form className="flex flex-col gap-4">
              <input
                ...
                required
                className="px-4 py-3 rounded-full text-sm bg-white/10 text-white placeholder-blue-300 outline-none focus:bg-white/20"
              />
              <input
                type="text"
